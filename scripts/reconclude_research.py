...
# 旧四段式(## 核心观点 开头)、旧两段式(缺交易要素节)、缺『多空要点』节
# (2026-09-07 观点要点新口径前生成)与失败占位都不齐备。
...
# 是"交易要素"节标题的解析端语义,web_app._parse_duo_points 是"多空要点"节的
# 解析端,改任一侧小节标题须对齐另一侧。
_NEW_FMT_MARKERS = ("## 供需格局", "## 数据支撑", "## 交易要素与风险", "## 多空要点")
_FAIL_MARKER = "观点生成失败"

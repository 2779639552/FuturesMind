...
DEFAULT_KEYWORDS_XHS = [  # 【变量】小红书平台默认关键词列表 (20 品种池 + 通用主题词)
    # 能化 13
    "原油期货分析",
    "PTA期货",
    "对二甲苯期货",
...
DEFAULT_KEYWORDS_WEIBO = [  # 【变量】微博平台默认关键词列表 (品种级短词, 20 品种池)
    "原油",
    "PTA",
    "对二甲苯",
    "乙二醇",
...
DEFAULT_KEYWORDS_ZHIHU = [  # 【变量】知乎平台默认关键词列表 (偏问答/讨论向, 20 品种池)
    "期货",
    "商品期货",
    "原油",
    "沥青",
...
DEFAULT_KEYWORDS_XUEQIU = [  # 【变量】雪球平台默认关键词列表 (20 品种池)
    "原油",
    "PTA",
    "对二甲苯",
    "乙二醇",
...
DEFAULT_KEYWORDS_EASTMONEY_GUBA = [  # 【变量】东财股吧平台默认关键词列表(带"期货"后缀, 20 品种池+池内品种长尾)
    # 能化 13
    "原油期货",
    "PTA期货",
    "对二甲苯期货",

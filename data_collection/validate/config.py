...
PLATFORM_KEYWORDS = {  # 【变量】平台名→按平台调优的搜索关键词(各平台搜索习惯不同)
    ...
    "eastmoney_guba": [
        # 东财股吧搜索带"期货"后缀更精准, 覆盖33品种池+稀疏品种长尾扩充
        # 黑色系
        ...
        # 能化 (2026-09-01 扩能化整组 12 品种)
        "原油期货", "PTA期货", "甲醇期货", "纯碱期货", "PVC期货", "玻璃期货", "尿素期货",
        "橡胶期货", "沥青期货", "燃料油期货", "低硫燃料油期货", "20号胶期货",
        "苯乙烯期货", "乙二醇期货", "塑料期货", "PP期货", "对二甲苯期货", "短纤期货",
        # 农产品
        "豆粕期货", "豆油期货", "棕榈油期货", "菜粕期货", "白糖期货", "棉花期货",
        "玉米期货", "生猪期货", "鸡蛋期货", "苹果期货", "红枣期货", "花生期货",
        # 稀疏品种长尾扩充(不用裸"苹果"避免撞Apple)
        "苹果冷库", "苹果套袋", "玻璃库存", "浮法玻璃", "尿素出口", "涤纶短纤",
        "短纤报价", "红枣库存", "花生库存",
        # 主题词
        "期货实盘", "期货技术分析", "期货基本面", "商品期货", "期货实战", "期货交易心得",
    ],
}
